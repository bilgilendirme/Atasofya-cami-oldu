# Ayasofya Cami Oldu Yunan Kudurdu
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/g3sdflye/settings/api) and create a token with read rights.
